#ifndef INPUT_DEFINES_HPP
#define INPUT_DEFINES_HPP

// Teclas de teclado (GLFW_KEY_* a KEY_NOMBRE)
...
// Botones del ratón (GLFW_MOUSE_BUTTON_* a MOUSE_BTN_NUMERO)
